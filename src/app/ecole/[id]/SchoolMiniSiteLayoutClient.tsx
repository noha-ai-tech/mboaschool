...
//
// RELEASE-CONSOLIDATION-07 — split out of layout.tsx verbatim so layout.tsx
// can become a Server Component emitting per-school JSON-LD as a sibling of
// this client tree (not nested inside it) — see layout.tsx for why that
