...
--
-- Historically executed in production under filename 0028_fix_publish_school_page_owner_check.sql
-- (branch feat/pro-school-organization). Renumbered to 0031_fix_publish_school_page_owner_check.sql during
...
-- database. The SQL body below is byte-for-byte unchanged from 0028_fix_publish_school_page_owner_check.sql;
