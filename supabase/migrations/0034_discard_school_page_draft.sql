...
--
-- Historically executed in production under filename 0031_discard_school_page_draft.sql
-- (branch feat/pro-school-organization). Renumbered to 0034_discard_school_page_draft.sql during
...
-- database. The SQL body below is byte-for-byte unchanged from 0031_discard_school_page_draft.sql;
