...
--
-- Historically executed in production under filename 0023_multi_school_rls_context.sql
-- (branch feat/pro-school-organization). Renumbered to 0026_multi_school_rls_context.sql during
...
-- database. The SQL body below is byte-for-byte unchanged from 0023_multi_school_rls_context.sql;
