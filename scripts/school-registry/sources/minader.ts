...
// ============================================================================
// Adaptateur MINADER — Écoles de formation agricole
//
...
export function createMinaderAdapter(): SourceAdapter {
  return {
    ministry: "MINADER",
    sourceName: "À déterminer",
    async fetchAll(): Promise<RawSourceRecord[]> {
      throw new Error(
        "Adaptateur MINADER non implémenté — voir SOURCE_CATALOG.md pour le statut de cette source."
      );
    },
  };
}
